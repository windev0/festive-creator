          ...
          <div className="grid gap-6">
            <div className="flex flex-col gap-4">
              <form
                onSubmit={async (e) => {
                  e.preventDefault();
                  await handleSubmit(LOGIN_TYPE.OAUTH, e, OAuthProvider.Apple); // with Apple
                }}
              >
                <Button
                  variant="outline"
              ...
              <form
                onSubmit={async (e) => {
                  e.preventDefault();
                  await handleSubmit(LOGIN_TYPE.OAUTH, e, OAuthProvider.Google); // with Google
                }}
              >
                <Button
                  variant="outline"
            ...
            <form
              onSubmit={async (e) => {
                e.preventDefault();
                await handleSubmit(LOGIN_TYPE.EMAIL_PASSWORD, e);
              }}
            >
              <div className="grid gap-6">
